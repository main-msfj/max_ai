...
class AgentError(Exception):
    ...
    @classmethod
    def unsafe_local_executor_for_skills(cls, agent_name: str) -> t.Self:
        return cls(
            f"Agent {agent_name!r} has skills, but skills cannot run with "
            "LocalExecutor. Use a sandboxed executor instead."
        )
